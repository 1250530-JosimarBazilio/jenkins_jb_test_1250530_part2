...
public class AuthorController {
    ...
    // Create with JSON
    @Operation(summary = "Creates a new Author with JSON body")
    ...
    // Create with Form Data (multipart)
    @Operation(summary = "Creates a new Author with form data")
    ...
    // Update with JSON
    @Operation(summary = "Updates a specific author with JSON body")
    ...
    // Update with Form Data (multipart)
    @Operation(summary = "Updates a specific author with form data")
    ...
    // Delete a foto
    @Operation(summary = "Deletes an author photo")
    @DeleteMapping("/{authorNumber}/photo")
    public ResponseEntity<Void> deleteAuthorPhoto(@PathVariable("authorNumber") final Long authorNumber) {

        Optional<Author> optionalAuthor = authorService.findByAuthorNumber(authorNumber);
        if (optionalAuthor.isEmpty()) {
            throw new NotFoundException("Author could not be found with provided authorNumber");
        }
